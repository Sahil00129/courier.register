...
@section('content')
    ...
    <style>
        ...
        .senderBlock .senderId, .senderBlock .senderLocation {
            display: flex;
            flex-flow: column;
            justify-content: center;
            width: 110px;
        ...
        .senderBlock .senderId span:nth-of-type(1), .senderBlock .senderLocation span:nth-of-type(1) {
            font-size: 12px;
        }
        ...
        .terBlock .terDates, .terBlock .terAmount {
            display: flex;
            flex-flow: column;
            justify-content: center;
        }
        ...
        <div class="row layout-top-spacing" id="cancel-row">
            <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    ...
                    <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                        ...
                        <tr>
                                    ...
                                    <div class="uid">
                                        ...
                                        <div class="terDetails">
                                            ...
                                            <div class="courier d-flex align-items-center" style="gap: 1rem">
                                                ...
                                                <p><strong>Docket No.:</strong> {{ $tercourier->docket_no ?? '-' }}</p>
                                                |
                                                <p><strong>Docket
                            ...
                            <td>
                                <ul class="dates d-flex flex-column justify-content-center">
                                    @if($tercourier->received_date)
                                        <li>Receipt: {{ Helper::ShowFormatDate($tercourier->received_date) }}</li>@endif
                            ...
                            <td>
                                <div class="action d-flex justify-content-center align-items-center">
                                    {{--                                    <a href="{{url('edit_ter_reception')}}" target="_blank">--}}
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                         viewBox="0 0 24 24"
                                         fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                         stroke-linejoin="round" class="feather feather-edit"
                                         data-toggle="modal" data-target="#editTerModal"
                                         v-on:click="open_edit_reception_ter_modal()">
                        ...
                        <tr>
                            <td colspan="6">
                                ...
                                <button type="submit" name="save" id="save" value="save" class="btn btn-primary" hidden>
                ...
                <!-- Modal -->
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="recipient-name" v-model="ter_id"
                                                   disabled>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-primary" @click="cancel_ter()"
                                ...
                                <div class="modal-body">
                                    <form>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" accept=".jpg,.pdf" class="form-control-file"
                    ...
                    <div class="modal fade show" id="editTerModal" v-if="edit_reception_ter_modal" tabindex="-1"
                        ...
                        <div class="modal-dialog" role="document" style="min-width: min(90%, 1100px)">
                            <div class="modal-content" style="position: relative;">
                                <div class="editTer modal-body editTer">
                                    ...
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            {{--                                                <option--}}
                                            {{--                                                    v-for="sender_all_info in senders_data"--}}
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control mbCheckNm form-control-sm"
                                                   id="telephone_no"
                                                   readonly="readonly" name="telephone_no" autocomplete="off"
                                                   maxlength="10"
                                                   type="tel">
                                        </div>
                                        <div class="form-group col-md-4">
                                    ...
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="docket_no"
                                                   name="docket_no" autocomplete="off">
                                        </div>
                                        <div class="form-group col-md-4">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     ...
                                     @click="edit_reception_ter_modal=false;">
                                    <circle cx="12" cy="12" r="10"></circle>
    ...
    <script>
        new Vue({
            ...
            data: {
                ...
                edit_reception_ter_modal: false,
                ter_id: "",
                cancel_remarks: "",
                diff_amount: "",
                partial_remarks: "",
            ...
            methods: {
                ...
                // open_edit_reception_ter_modal: function (ter_id) {
                open_edit_reception_ter_modal: function () {
                    // this.ter_id = ter_id;
                    this.edit_reception_ter_modal = true;
                },
