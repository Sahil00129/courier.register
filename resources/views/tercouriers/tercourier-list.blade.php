                ...
                <div class="widget-content widget-content-area br-6">
                                ...
                                @foreach ($tercouriers as $key => $tercourier)
                                    <tr>
                                        <td style="padding: 10px 21px;">
                                            <input type="checkbox" id="selectboxid" name="select_box[]"
                                                   class="selected_box"
                                            ...
                                            <div class="d-flex align-items-center" style="gap: 4px;">
                                                ...
                                                <div class="uid">
                                                    ...
                                                    <div class="terDetails">
                                                        ...
                                                        <div class="courier d-flex align-items-center"
                                                             style="gap: 1rem">
                                                            <p><strong>Courier
                                        ...
                                        <td>
                                            ...
                                            @elseif($tercourier->status == 5)
                                                <button class="btn {{ $class }} btn-sm btn-rounded mb-2 statusButton"
                                                        ...
                                                        v-on:click="open_partial_paid_modal(<?php echo $tercourier->id ?>)">
                                                    {{ $status }}
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                         viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                         stroke-width="2"
                        ...
                        {{--
                            <table id="html5-extensio" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <td style="cursor:pointer" data-toggle="modal" data-target="#partialpaidModal"
                                        v-on:click="open_partial_paid_modal(<?php echo $tercourier->id ?>)">{{ $tercourier->id }}</td>
                                    <?php } else { ?>
                                    <td>{{ $tercourier->id }}</td>
                                    <?php } ?>
                                    <?php
                                    ...
                                    <td>
                                        <div class="action d-flex justify-content-center align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                 ...
                                                 stroke-linecap="round" stroke-linejoin="round"
                                                 class="feather feather-edit"
                                                 data-toggle="modal" data-target="#editTerModal"
                                                 v-on:click="get_data_by_id(<?php echo $tercourier->id ?>)">
                                                <path
                                                    d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                                <path
                                                    d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                    ...
                                    <td>
                                        <div class="action d-flex justify-content-center align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                 ...
                                                 stroke-linecap="round" stroke-linejoin="round"
                                                 class="feather feather-edit"
                                                 v-on:click="get_data_by_id('not_allowed')">
                                                <path
                                                    d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                                <path
                                                    d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                    ...
                    <div class="d-flex justify-content-between align-items-start px-3">
                        <div class="d-flex align-items-center" style="width: 200px; gap: 4px;">
                            Rows on page:
                            <select id="month" class=" form-control form-control-sm form-control-sm-30px"
                                    onchange="setRowsOnPage(this.value)" style="width: 80px">
                    ...
                    <!-- Modal -->
                    <div class="modal fade show" id="exampleModal" v-if="ter_modal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-body">
                                    <form>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="recipient-name"
                                                   v-model="cancel_remarks">
                                        </div>
                                    </form>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-primary" style="border-radius: 8px;"
                                            @click="cancel_ter()"
                    ...
                    <!-- Partial Paid Modal -->
                    <div class="modal fade show" id="partialpaidModal" v-if="partial_paid_modal" tabindex="-1"
                         role="dialog" aria-labelledby="partialpaidModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="partialpaidModalLabel">Partial Paid - TER ID:
                                        @{{ter_id}}</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                                            @click="partial_paid_modal=false;">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <form>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" accept=".jpg,.pdf"
                                                   ...
                                                   id="fileupload" v-on:change="upload_file($event)">
                                        </div>
                                    </form>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-primary" @click="update_payment()"
                                            data-dismiss="modal" style="border-radius: 8px;">Save changes
                                    </button>
                                    <!-- <button type="button" class="btn btn-secondary"  data-dismiss="modal" >Get Passbook</button> -->
                                    <!-- <button type="button" class="btn btn-secondary"  data-dismiss="modal"  @click="emp_modal=false;emp_advance_amount=''">Close</button> -->
                                </div>
                    ...
                    <div class="modal fade show" id="editTerModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document" style="min-width: min(90%, 1100px)">
                            <div class="modal-content" style="position: relative;">
                                    ...
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" class="form-control form-control-sm"
                                                   name="date_of_receipt" v-model="date_of_receipt">
                                        </div>
                                        <!--------------- end ------------------>
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control mbCheckNm form-control-sm"
                                                   id="telephone_no" v-model="sender_telephone" readonly="readonly"
                                                   name="telephone_no" autocomplete="off" maxlength="10" type="tel">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputPassword4">Status</label>
                                            <input type="text" class="form-control form-control-sm" id="emp_status"
                                                   v-model="sender_status" name="emp_status" autocomplete="off"
                                                   readonly="readonly"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control form-control-sm location1"
                                                   id="location" name="location" v-model="location">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputState">Company Name</label>
                                            <select id="select_option" name="company_name"
                                                    class="form-control form-control-sm" v-model="company_name">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="amount"
                                                   name="amount" v-model="amount" required>
                                        </div>

                                        <div class="form-group col-md-3 n-chk align-self-center">
                                            <label class="new-control new-radio radio-classic-primary">
                                                <input v-on:change="onChangePeriodType()" id="for_month" type="radio"
                                                       class="new-control-input" name="period_type">
                                                <span class="new-control-indicator"></span>For Month
                                            </label>
                                            <label class="new-control new-radio radio-classic-primary">
                                                <input checked="checked" v-on:change="onChangePeriodType()"
                                                       id="for_period" type="radio" class="new-control-input"
                                                       name="period_type">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="details"
                                                   name="details" v-model="details">
                                        </div>
                                        <div class="form-group col-md-8">
                                            <label for="remarks">Remarks</label>
                                            <textarea name="remarks"
                                                      class="form-control form-control-sm form-control-sm-30" rows="1"
                                                      cols="70" v-model="remarks"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="docket_no"
                                                   v-model="docket_no" name="docket_no" autocomplete="off">
                                        </div>
                                        <div class="form-group col-md-4">
                                ...
                                <div style="min-height: 90vh;" v-else
                                     class="d-flex justify-content-center align-items-center">
                                    Loading...
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                     stroke-linejoin="round" class="closeButton feather feather-x-circle"
