                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="form-row mb-4">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="date" class="form-control form-control-sm" id="terfrom_date" name="terfrom_date" readonly="readonly" v-model="terfrom">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="inputPassword4">TER Period To</label>
                                <input type="date" class="form-control form-control-sm" id="terto_date" name="terto_date" readonly="readonly" v-model="terto">
                            </div>

                            <div class="form-group col-md-3">
                                <label for="remarks">Advance Amount</label>
                                <input type="text" class="form-control form-control-sm" id="details" name="details" readonly="readonly" v-model="current_balance">
                            </div>
                            <div class="form-group col-md-3">
                        ...
                        <div v-if="!update_ter_flag">
                            <div class="form-row mb-0">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" class="form-control form-control-sm" id="payable_" name="payable_" v-model="payable_amount" placeholder="Enter Payable Amount" :disabled="flag">
                                </div>
                                <div class="form-group col-md-6">
