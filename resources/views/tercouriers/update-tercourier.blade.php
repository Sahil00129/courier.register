                    ...
                    <div class="widget-content widget-content-area">
                        <div class="form-row mb-4">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control form-control-sm" name="from" v-model="emp_details" disabled>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputPassword4">Date of Receipt</label>
                                <input type="date" class="form-control form-control-sm" name="date_of_receipt" v-model="date_of_receipt" disabled>
                            </div>

                            <div class="form-group col-md-4">
                                <label for="inputPassword4">Location</label>
                                <input type="text" class="form-control form-control-sm" id="location" name="location" v-model="location" readonly="readonly">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="inputPassword4">Telephone No.</label>
                                <input type="text" class="form-control form-control-sm mbCheckNm" id="telephone_no" name="telephone_no" autocomplete="off" maxlength="10" readonly="readonly" v-model="telephone_no">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="inputPassword4">Status</label>
                                <input type="text" class="form-control form-control-sm" id="emp_status" name="emp_status" autocomplete="off" readonly="readonly" v-model="status" />
                        ...
                        <div class="form-row mb-4">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control form-control-sm" id="amount" name="amount" readonly="readonly" v-model="amount">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputState">Location</label>
                                <input type="text" class="form-control form-control-sm location1" id="location" name="location" readonly="readonly" v-model="doc_location">
                            </div>

                            <div class="form-group col-md-3 n-chk align-self-center">
                                <label class="new-control new-radio radio-classic-primary">
                                    <input onchange="onChangePeriodType()" id="for_month" disabled type="radio" class="new-control-input" name="period_type">
                                    <span class="new-control-indicator"></span>For Month
                                </label>
                                <label class="new-control new-radio radio-classic-primary">
                                    <input checked="checked" onchange="onChangePeriodType()" id="for_period" disabled type="radio" class="new-control-input" name="period_type">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="date" class="form-control form-control-sm" id="terfrom_date" name="terfrom_date" v-model="terfrom">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="inputPassword4">TER Period To</label>
                                <input type="date" class="form-control form-control-sm" id="terto_date" name="terto_date" v-model="terto">
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control form-control-sm" id="details" name="details" readonly="readonly" :value="this.all_data.details">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="remarks">Remarks</label>
                                <textarea name="remarks" class="form-control form-control-sm form-control-sm-30" rows="1" cols="70" readonly="readonly" :value="this.all_data.remarks"></textarea>
                            </div>
                        </div>
                        <!--------------- end ------------------>
                        ...
                        <div class="form-row mb-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control form-control-sm" id="courier_name" autocomplete="off" readonly="readonly" v-model="courier_name">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="inputPassword4">Docket No.</label>
                                <input type="text" class="form-control form-control-sm" id="docket_no" name="docket_no" autocomplete="off" readonly="readonly" v-model="docket_no">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="inputPassword4">Docket Date</label>
                                <input type="date" class="form-control form-control-sm" id="docket_date" name="docket_date" readonly="readonly" v-model="docket_date">
                        ...
                        <div v-if="!update_ter_flag">
                            <div class="form-row mb-0">
                                ...
                                <div class="form-group col-md-6 mb-0">
                                    ...
                                    <input type="number" class="form-control form-control-sm" id="payable_" name="payable_" v-model="payable_amount" @keyup="amount_in_words(payable_amount)" placeholder="Enter Payable Amount" :disabled="flag">
                                ...
                                <div class="form-group col-md-6 mb-0">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="voucher_c" name="voucher_c" v-model="voucher_code" placeholder="Enter Voucher Code" :disabled="flag">
                                </div>
                            </div>
                        </div>
                        <div v-if="update_ter_flag">
                        ...
                        <div class="d-flex flex-wrap align-items-center" style="gap: 6px;" id="tb-box">
                            <p style="font-size: 1rem; font-weight: 700; margin-bottom: 0;">Select the Deduction Remarks</p>
                            <ul class="styledCheckbox">
                                <li>
                                    <input type="checkbox" class="select_box" id="lateFine" value="1" />
                                    <label for="lateFine">Late fine INR 200 deducted – TER received after 15 days</label>
                                </li>
                                <li>
                                    <input type="checkbox" class="select_box" id="fuelLimit" value="2" />
                                    <label for="fuelLimit"> Fuel limit exceeded</label>
                                </li>
                                <li>
                                    <input type="checkbox" class="select_box" id="telephoneLimit" value="3" />
                                    <label for="telephoneLimit">Telephone/Mobile limit exceeded</label>
                                </li>
                                <li>
                                    <input type="checkbox" class="select_box" id="maintenance" value="4" />
                                    <label for="maintenance">Maintenance limit exceeded</label>
                                </li>
                                <li>
                                    <input type="checkbox" class="select_box" id="lodging" value="5" />
                                    <label for="lodging">Lodging & Boarding deductions</label>
                                </li>
                                <li>
                                    <input type="checkbox" class="select_box" id="publicLimit" value="6" />
                                    <label for="publicLimit">Public Transportation/food limit exceeded</label>
                                </li>
                                <li>
                                    <input type="checkbox" class="select_box" id="limitExceed" value="7" />
                                    <label for="limitExceed">Courier/Internet/Stationary limit exceeded</label>
                                </li>
                            </ul>
                        </div>

                        <div class="d-flex">
                            <button type="button" class="btn btn-primary addButton" name="button" @click="addAnotherpayment" :disabled="update_ter_flag">
                                Add
                            </button>
                            <div class="flex-grow-1 d-flex justify-content-end">
                                <ul class="schools" style="list-style-type: none; -webkit-columns: 1;-moz-columns: 1;columns: 1;">
                                    <li v-for="(payment_data,index) in pay_data_array" style="font-weight:bold">
                                        ...
                                        <button @click="removePayment(payment_data)" class="btn btn-sm btn-danger removeButton">
                                            Remove
                                        </button>
                                    </li>
                                </ul>
