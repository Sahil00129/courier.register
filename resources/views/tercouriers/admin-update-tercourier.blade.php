        ...
        <div class="container">
            <div class="page-header">
                ...
                <div id="html5-extension_filter" class="dataTables_filter"><label>
                        <input type="text" class="form-control form-control-sm-30px" id="search_item"
                               placeholder="Enter UN ID" v-model="unique_id" aria-controls="html5-extension"></label>
                        ...
                        <div class="widget-content widget-content-area">
                            <div class="form-row mb-4">
                                ...
                                <div class="form-group form-group-sm col-md-6">
                                    ...
                                    <input type="date" class="form-control" name="date_of_receipt"
                                           :value="this.all_data.date_of_receipt" disabled>
                                </div>
                                <!--------------- end ------------------>
                                ...
                                <div class="form-group form-group-sm col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="location" name="location"
                                           v-model="sender_location" readonly="readonly">
                                </div>
                                <div class="form-group form-group-sm col-md-4">
                                    <label for="inputPassword4">Telephone No.</label>
                                    <input type="text" class="form-control mbCheckNm" id="telephone_no"
                                           name="telephone_no" autocomplete="off" maxlength="10" readonly="readonly"
                                           v-model="sender_telephone">
                                </div>
                                <div class="form-group form-group-sm col-md-4">
                                    <label for="inputPassword4">Status</label>
                                    <input type="text" class="form-control" id="emp_status" name="emp_status"
                                           autocomplete="off" readonly="readonly" v-model="sender_status"/>
                            ...
                            <div class="form-row mb-4">
                                ...
                                <div class="form-group form-group-sm col-md-4">
                                    ...
                                    <input type="text" class="form-control location1" id="location" name="location"
                                           readonly="readonly" :value="this.all_data.location">
                                </div>
                                <div class="form-group form-group-sm col-md-4">
                                ...
                                <div class="form-group form-group-sm col-md-3">
                                    ...
                                    <input type="date" class="form-control" id="terfrom_date" name="terfrom_date"
                                           v-model="terfrom">
                                </div>
                                <div class="form-group form-group-sm col-md-3">
                                    <label for="inputPassword4">TER Period To</label>
                                    <input type="date" class="form-control" id="terto_date" name="terto_date"
                                           v-model="terto">
                                </div>
                                ...
                                <div class="form-group form-group-sm form-group-sm-30 col-md-5">
                                    ...
                                    <textarea name="remarks" class="form-control" rows="1" cols="70" readonly="readonly"
                            ...
                            <div class="form-row mb-4">
                                ...
                                <div class="form-group form-group-sm col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="courier_name" autocomplete="off"
                                           readonly="readonly" :value="this.all_data.courier_company.courier_name">
                                </div>
                                <div class="form-group form-group-sm col-md-4">
                                    <label for="inputPassword4">Docket No.</label>
                                    <input type="text" class="form-control" id="docket_no" name="docket_no"
                                           autocomplete="off" readonly="readonly" :value="this.all_data.docket_no">
                                </div>
                                <div class="form-group form-group-sm col-md-4">
                                    <label for="inputPassword4">Docket Date</label>
                                    <input type="date" class="form-control" id="docket_date" name="docket_date"
                                           readonly="readonly" :value="this.all_data.docket_date">
                                </div>
                            </div>
                            ...
                            <div v-if="!update_ter_flag">
                                <div class="form-row mb-0">
                                    ...
                                    <div class="form-group form-group-sm col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="payable_" name="payable_"
                                               v-model="payable_amount" placeholder="Enter Payable Amount">
                                    </div>
                                    <div class="form-group form-group-sm col-md-6">
                                        <label for="voucher_c">Voucher Code</label>
                                        <input type="text" class="form-control" id="voucher_c" name="voucher_c"
                                               v-model="voucher_code" placeholder="Enter Voucher Code">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div v-if="update_ter_flag" class="form-row ">
                                <h6><b>Details</b></h6>
                                <div class="detailsBox px-2 py-3 d-flex justify-content-between align-items-center flex-wrap"
                                     style="gap: 1rem;">
                                    <ul class="schools"
                                        style="list-style-type: none; -webkit-columns: 1;-moz-columns: 1;columns: 1;">
                                        <li v-for="(payment_data_new,index) in db_pay_data_array"
                                            style="font-weight:bold;font-size:14px"><b>
                                    ...
                                    <button type="button" class="btn btn-primary" name="button"
                                            @click="edit_payable_func"
                                            v-if="edit_btn_flag">Edit
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="flex-grow-1 d-flex justify-content-between">
                                <div class="d-flex align-items-center" style="gap: 0.5rem;">
                                    <button type="button" class="btn btn-primary" name="button"
                                            @click="addAnotherpayment" v-if="edit_payable">Add
                                    </button>
                                    <button type="button" class="btn btn-primary" name="button"
                                            @click="cancel_payable_func" v-if="edit_payable">Cancel
                                    </button>
                                </div>
                                ...
                                <ul class="schools"
                                    ...
                                    <li v-for="(payment_data,index) in pay_data_array" style="font-weight:bold">
                                        ...
                                        <button @click="removePayment(payment_data)"
                                                class="btn btn-sm btn-danger removeButton">Remove
                                        </button>
                                    </li>
                                </ul>
                            </div>
