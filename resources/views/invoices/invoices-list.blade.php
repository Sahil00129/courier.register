                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center justify-content-center" style="gap: 8px">
                                        ...
                                        @elseif ($role == 'sourcing-admin' && $tercourier->status== 2)
                                        <div class="action d-flex justify-content-center align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit" v-on:click="edit_verify_invoice(<?php echo $tercourier->id ?>)">
                                                <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                                <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                            </svg>
                                        </div>
...
<script>
    new Vue({
        ...
        methods: {
            ...
            edit_verify_invoice(id) {
                this.invoice_id = id;
                this.loader = true;
                // window.location="/pages/employee-passbook";
                // setTimeout(() => {window.location.href = "/employee-passbook"},2000);
                axios.post('/edit_verify_invoice', {
                        'id': this.invoice_id
                    })
                    .then(response => {
                        if (response.data) {
