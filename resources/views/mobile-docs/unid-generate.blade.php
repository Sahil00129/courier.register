...
<body>
    ...
    <main id="generateUnid">
        <section id="loading_screen" class="animate__animated animate__fadeIn">
            <div class="flex flex-wrap md:flex-nowrap justify-center flex-col md:flex-row mx-auto text-center" style="height: 100%; align-items: center; max-width: 900px; row-gap: 2rem">
        ...
        <section id="landing_screen" class="animate__animated animate__fadeIn ">
            <div class="flex flex-wrap md:flex-nowrap justify-center flex-col md:flex-row mx-auto text-center" style="height: 100%; align-items: center; max-width: 900px; row-gap: 2rem">
                ...
                <img src="{{asset('assets/img/hero-illustration.png')}}" alt="sss" class="heroIllustration animate__animated animate__fadeIn" />

                <div class="flex flex-col align-center justify-center mb-12 md:mb-0 flex-1">
                    <img src="{{asset('assets/img/ter-logo.png')}}" alt="sss" class="terLogo hidden md:flex animate__animated animate__slideInUp" />
                    ...
                    <div class="mt-10 flex items-center justify-center gap-x-6 animate__animated animate__slideInUp">
                        <button class="flex justify-center themeButton" onClick="onClickGenerate()" style="max-width: 170px">
                            Generate
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevrons-right normalSvg">
                                <polyline points="13 17 18 12 13 7"></polyline>
                                <polyline points="6 17 11 12 6 7"></polyline>
                            </svg>
                        </button>
                        <button class="flex justify-center themeButton reverse" onClick="onClickTrack()" style="max-width: 170px">
                            Track
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevrons-right normalSvg">
                                <polyline points="13 17 18 12 13 7"></polyline>
                                <polyline points="6 17 11 12 6 7"></polyline>
        ...
        <section id="generate_unId" class="generateUnId animate__animated animate__fadeIn">
            <div class="flex flex-wrap md:flex-nowrap justify-center flex-col md:flex-row mx-auto text-center" style="flex: 1; height: 100%;">
                <div class="formBlock">
                    ...
                    <div class="formContainer animate__animated animate__fadeIn">
                        ...
                        <div class="containerArea animate__animated animate__fadeIn">
                            ...
                            <div class="loadingBox inActive">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-loader loadingSvg">
                            ...
                            <img src="{{asset('assets/img/ter-logo.png')}}" alt="sss" class="terLogo animate__animated animate__slideInUp" />
                            ...
                            <div class="midContent">
                                ...
                                <div class="userCard compact animate__animated animate__fadeIn inActive">
                                    ...
                                    <div class="inner">
                                        <p class="empId"><span>@{{employee_data.employee_id}}</span>
                                ...
                                <p class="verifyOtpSection text-sm leading-8 text-center animate__animated animate__bounceIn inActive" style="color: green">
                            ...
                            <div class="formItems">
                                ...
                                <div class="mobileInputSection myInputBox animate__animated animate__fadeIn active">
                                    <input type="number" name="mobile_number" id="mobile_number" placeholder="Your Mobile Number" v-model="mobile_no" class="myInput" onkeyup="enableButton()" />
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-phone">
                                        <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                                    </svg>
                                    <p class="errorLabel"></p>
                                </div>
                                <button id="getInfoButton" class="mobileInputSection themeButton animate__animated animate__slideInUp loadingButton active" disabled @click="check_employee_exist()">
                                ...
                                <p class="mobileInputSection changeNumber animate__animated animate__slideInUp active" onclick="onClickTrackOldOne()">
                                    Track Un Id</p>

                                <!-- send Otp section -->
                                <button id="sendOtpButton" class="sendOtpSection themeButton animate__animated animate__slideInUp loadingButton inActive" @click="send_otp()">
                                ...
                                <p id="changeNumber" class="sendOtpSection changeNumber animate__animated animate__slideInUp inActive" @click="onClickChangeNumber()">
                                    Change
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-phone">
                                        <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                                    </svg>
                                ...
                                <button id="verifyOtpButton" class="verifyOtpSection themeButton animate__animated animate__slideInUp loadingButton inActive" @click="submit_otp()" disabled>
                                ...
                                <p class="verifyOtpSection disabled timer changeNumber animate__animated animate__slideInUp inActive" @click="send_otp()">
                                ...
                                <div class="generateUnIdSection myInputBox animate__animated animate__fadeIn inActive">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" id="svg3611" viewBox="0 0 169.76 250.39" version="1.1">
                                        <g id="layer1" transform="translate(0 -801.97)">
                                            <path id="path4158" style="stroke:var(--primaryColor);stroke-width:.099084;fill:var(--primaryColor)" d="m99.017 1052.3-90.577-113.33 0.5232-22.46c42.51 2.93 75.559-1.57 83.248-41.78l-90.578-0.52 14.66-24.55 72.253 1.04c-11.009-22.88-41.286-25.7-88.484-24.02l16.231-24.03 153.41-0.22927-15.184 23.731h-42.409c7.7512 8.1823 13.424 17.597 13.613 25.591l43.98-0.52226-15.184 23.502-29.32 0.52229c-4.5772 35.058-36.787 55.815-77.489 60.584l91.184 116.44-39.874 0.022v0.0004z"></path>
                                        </g>
                                    </svg>
                                ...
                                <div class="generateUnIdSection myInputBox animate__animated animate__fadeIn inActive">
                                    <input type="file" accept="capture=camera, image/png, image/jpg, image/jpeg" name="scanning_file[]" v-on:change="upload_file($event)" id="fileupload-0" class="myInput unIdInput" required />
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-paperclip">
                                        <path d="M21.44 11.05l-9.19 9.19a6 6 0 0 1-8.49-8.49l9.19-9.19a4 4 0 0 1 5.66 5.66l-9.2 9.19a2 2 0 0 1-2.83-2.83l8.49-8.48"></path>
                                    </svg>
                                    <p class="errorLabel"></p>
                                </div>
                                <button id="generateUnIdButton" class="generateUnIdSection themeButton disabled animate__animated animate__slideInUp loadingButton inActive" @click="generate_unid()">
                                ...
                                <p class="generateUnIdSection changeNumber animate__animated animate__slideInUp inActive" id="lastSectionError" style="color: darkred">
                                    &nbsp;
                                </p>
                            </div>
                        </div>
                ...
                <div class="formBlock">
                    <div class="formContainer animate__animated animate__fadeIn">
                        ...
                        <div class="containerArea animate__animated animate__fadeIn">
                            ...
                            <img src="{{asset('assets/img/ill-1.svg')}}" alt="demo Illustration" class="trackUnIdSection inlineIllustration active" />
                            ...
                            <div class="unIdStatus trackingResultSection animate__animated animate__fadeIn inActive">
                                <img :src="src_img" alt="demo Illustration" class="trackingResultSection animate__animated animate__fadeIn inlineIllustration inActive" style="margin: 1rem auto" />
                                ...
                                <div class="paymentReceiptBox" v-if="payment_receipt">
                                    <a class="mailButton paymentReceiptSection animate__animated animate__slideInUp active" @click="sendPaymentOtp()">
                                        Generate Payment Receipt
                                    </a>
                                    @if(true)
                                    <div class="paymentOtpSection myInputBox animate__animated animate__slideInUp inActive">
                                        <input type="number" name="paymentOtp" id="paymentOtp" placeholder="Enter OTP received on Mobile" class="myInput" @keyup="enableMailButton()" v-model="payment_otp" />
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-lock">
                                            <rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect>
                                            <path d="M7 11V7a5 5 0 0 1 10 0v4"></path>
                                        </svg>
                                    ...
                                    <a class="paymentOtpSection mailButton animate__animated animate__slideInUp inActive disabled" @click="verify_pr_otp()">
                                    ...
                                    <p class="emailSentSuccess text-sm text-center animate__animated animate__fadeIn inActive" style="color: green">
                            ...
                            <div class="formItems">
                                ...
                                <div class="trackUnIdSection myInputBox animate__animated animate__fadeIn active">
                                    <input type="number" name="unId" id="unId" placeholder="Un Id" class="myInput" v-model="unid_no" @keyup="enableTrackButton()" />
                                ...
                                <button id="trackUnIdButton" class="trackUnIdSection themeButton animate__animated animate__slideInUp loadingButton active" @click="trackunid()" disabled>
                                ...
                                <p class="trackUnIdSection changeNumber animate__animated animate__slideInUp active" onclick="onClickGenerateNew()">
                                    Generate New</p>
                            </div>
                        </div>
