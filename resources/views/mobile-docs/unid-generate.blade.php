...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-86MC6YTNHE"></script>
    <script>
...
<body>
    ...
    <main id="generateUnid">
        <section id="loading_screen" class="animate__animated animate__fadeIn">
            <div class="flex flex-wrap justify-center flex-col mx-auto text-center animate__animated animate__zoomIn" style="height: 100%; align-items: center; max-width: 900px;">
                <img src="{{asset('assets/img/ter-logo.png')}}" alt="sss" class="terLogo loadingLogo animate__animated animate__fadeIn" />
        ...
        <section id="landing_screen" class="animate__animated animate__fadeIn ">
            <div class="flex flex-wrap md:flex-nowrap justify-center flex-col md:flex-row mx-auto text-center" style="height: 100%; align-items: center; max-width: 900px; width: 100%; row-gap: 2rem">
                        ...
                        <div class="containerArea animate__animated animate__fadeIn">
                            ...
                            <div class="formItems">
                                ...
                                <div class="trackUnIdSection myInputBox animate__animated animate__fadeIn active">
                                    <input type="number" name="unId" id="unId" placeholder="Enter UNID" class="myInput" v-model="unid_no" @keyup="enableTrackButton()" />
